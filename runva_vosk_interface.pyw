...
class App(tk.Tk):
    settings = {
        ...
        'textTitle':  'Голосовой ассистент Яся', # текст заголовка
        ...
        'isScrollbar': True,                # включает или выключает встроенную прокрутку
        ...
        # ------------------
        'isHideAfrerTime': False,             # скрывать после определенного времени
        ...
        'isSoundStart': True,                # прогигрывает звук после произношения "Ирина" (или любого другого Имени ассистента)
